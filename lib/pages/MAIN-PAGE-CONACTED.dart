              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        Expanded(child: BatteryTempInfo()),
                        SizedBox(height: 10),
                        Expanded(child: TotalDistanceInfo()),
                        SizedBox(height: 10),
                        /*SizedBox(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('assets/vectors/img.png'),
                    fit: BoxFit.cover, // Ajustez ceci en fonction de vos besoins (BoxFit.contain, BoxFit.fill, etc.)
                  ),
                ),
              ),
              SizedBox(height: 10,),
    ...
    return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            // Espace entre le texte 'battery temp' et la ligne suivante
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
            ...
            SizedBox(height: 10),
            // Espace entre la ligne de température et le texte 'Optimum'
            Text(
              'Optimum',
              style: GoogleFonts.montserrat(
                fontWeight: FontWeight.w600,
